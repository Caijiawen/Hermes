...
class AlgoTemplate(object):
    ...
    #----------------------------------------------------------------------
    def __init__(self, exchange, setting, algoName):
        """Constructor"""
    ...
    def getDepth(self, symbol):
        return self.exchange.getDepth(symbol)
    
    def getTrades(self, symbol):
        return self.exchange.getTrades(symbol)
    ...
    def subscribe(self, vtSymbol):
        """"""
        self.exchange.subscribe(self, vtSymbol)
    
    #----------------------------------------------------------------------
    def buy(self, vtSymbol, price, volume, priceType=None, offset=None):
        """"""
        return self.exchange.buy(self, vtSymbol, price, volume, priceType, offset)
    
    #----------------------------------------------------------------------
    def sell(self, vtSymbol, price, volume, priceType=None, offset=None):
        """"""
        return self.exchange.sell(self, vtSymbol, price, volume, priceType, offset)
    
    #----------------------------------------------------------------------
    def cancelOrder(self, vtOrderID):
        """"""
        return self.exchange.cancelOrder(self, vtOrderID)
